...
This guide was prepared by the [Center for Open and REproducible Science (CORES)](http://cores.stanford.edu/). See the [full list of contributors](#contributors) below.

*THIS IS CURRENTLY A WORK IN PROGRESS*

See the [Guide for Contributors](https://github.com/DSI-CORES/OpenByDesign/blob/master/CONTRIBUTING.md) if you wish to contribute to this project.
...
This guide is organized according to a number of different aspects of open science practices:

1. [Pre-registration](1_preregistration.md)
1. [Reproducible data analysis](4_reproducibleanalysis.md)
1. Reproducible modeling
1. [Reproducible manuscript](5_reproduciblemanuscripts.md)
1. Reproducible project
1. [Code sharing](2_codesharing.md)
1. [Data sharing](3_datasharing.md)
1. Open access publication

We also discuss several topics of the open science infrastructure:

1. Computer literacy
1. Programming
1. Project management

We have included some more general suggestions:

- [Joining the culture of open science](culture.md)

## Why should I do it?

As the availability of large datasets, powerful computational algorithms, and enormous computing power continues to expand and influence public policy and medical practice, it is crucial our research practices adapt to our evolving society. To do this, we need increased transparency and reproducibility in our scientific research. This is the ultimate goal of the open science movement. As scientists, we need to promote the integrity and public credibilty of science. 

## How this book is organized

We have organized this book to describe several open science practices with domain-specific examples of how they have been applied. These examples are critical for illustrating how to implement open science practices into your research workflow. Please feel free to add an example of incorporating these open science practices in your work! 

We understand the barrier to applying open science practices can be steep. In an effort to reduce the barrier to entry, we have a section to introduce you to several topics of the open science infrastructure. Developing and honing these skills will further strengthen your open science prowess. 
...
<table>
  ...
  <tr>
    ...
    <td align="center"><a href="https://github.com/franklin-feingold"><img src="https://avatars1.githubusercontent.com/u/35307458?v=4" width="100px;" alt=""/><br /><sub><b>Franklin Feingold</b></sub></a><br /><a href="#content-franklin-feingold" title="Content">🖋</a><a href="#design-franklin-feingold" title="Design">🎨</a><a href="#projectManagement-franklin-feingold" title="Project Management">📆</a></td>
