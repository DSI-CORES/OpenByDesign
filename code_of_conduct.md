...
Accordingly, everyone who participates in the Open By Design project is expected to show respect and courtesy to other community members at all times.

The organizers and members of the Open By Design project are dedicated to a ***harassment-free experience for everyone***, regardless of gender, gender identity and expression, sexual orientation, disability, physical appearance, body size, race, age or religion. **We do not tolerate harassment by and/or of members of our community in any form**.
...
Open By Design is a community-oriented and -led project.
...
To make clear what is expected, everyone participating in activities associated with the Open By Design project is required to conform to this Code of Conduct.
...
The lead investigator of the Open By Design project - Dr Russell Poldrack - is responsible for enforcing the Code of Conduct.
He can be contacted by emailing [russpold@stanford.edu](mailto:russpold@stanford.edu).
You may contact [Maya Mathur](mailto:mmathur@stanfored.edu) or [Franklin Feingold](mailto:ffein@stanford.edu) if you would prefer not to contact Dr Poldrack.
...
The Open By Design team are dedicated to providing a welcoming and supportive environment for all people, regardless of background or identity.
...
Everyone who participates in the Open By Design project activities is required to conform to this Code of Conduct.
This Code of Conduct applies to all spaces managed by the project including, but not limited to, in person focus groups and workshops, and communications online via GitHub.
By participating, contributors indicate their acceptance of the procedures by which the Open By Design project core development team resolves any Code of Conduct incidents, which may include storage and processing of their personal information.
...
Examples of unacceptable behaviour by Open By Design community members at any project event or platform include:
...
This applies to all Open By Design community events and platforms, either online or in-person.
...
Rather, you are invited to make suggestions for updates or clarifications by contacting Dr Russell Poldrack at [russpold@stanford.edu](mailto:russpold@stanford.edu) or by making a pull request to this document on GitHub.

## 3 Incident Reporting Guidelines

### 3.1 Contact points

If you feel able to, please contact Russell Poldrack by email at [russpold@stanford.edu](mailto:russpold@stanford.edu).

### 3.2 Alternate contact points

If you do not feel comfortable contacting Russell Poldrack, please report an incident to Maya Mathur by email at [mmathur@stanford.edu](mailto:mmathur@stanford.edu).

Alternatively, if you would like to contact someone outside of the core development team, please contact Chris Mentzel by email at [cmentzel@stanford.edu](mailto:cmentzel@stanford.edu).
...
This is the enforcement manual followed by the Open By Design project research team.
...
This can include contacting law enforcement (or other local personnel) and speaking on behalf of the Open By Design team.
...
In situations where an individual community member acts unilaterally, they must inform Russell Poldrack as soon as possible, and report their actions for review within 24 hours.
...
If the committee cannot reach consensus and deadlocks for over a week, Dr Poldrack, as lead investigator of the Open By Design project, will break the tie.
If Dr Poldrack is unable to take part in the discussion due to a conflict of interest, Chris Mentzel, as an external member of the CoC committee, will make the decision.
...
* A private written reprimand from a member of the research team to the individual(s) involved.
  In this case, the research team member will deliver that reprimand to the individual(s) over email, cc'ing Russell Poldrack for record keeping.
...
* An imposed "time out" from online spaces.
  Russell Poldrack will communicate this "time out" to the individual(s) involved.
* A permanent or temporary ban from some or all Open By Design project spaces (GitHub, in-person events etc).
...
In the event of any conflict of interest such that Dr Poldrack is not able to evaluate or enforce the reported violation, Chris Mentzel will take his place.

## 5 Acknowledgements

This code is adapted from the [Turing Way Code of Conduct](https://github.com/alan-turing-institute/the-turing-way/blob/master/CODE_OF_CONDUCT.md), which was adapted from the [Carpentries Code of Conduct](https://docs.carpentries.org/topic_folders/policies/code-of-conduct.html) with sections from the [Alan Turing Institute Data Study Group Code of Conduct](https://docs.google.com/document/d/1iv2cizNPUwtEhHqaezAzjIoKkaIX02f7XbYmFMXDTGY/edit). The Carpentries Code of Conduct was adapted from guidelines written by the [Django Project](https://www.djangoproject.com/conduct/enforcement-manual/), which was itself based on the [Ada Initiative template](http://geekfeminism.wikia.com/wiki/Conference_anti-harassment/Responding_to_reports) and the [PyCon 2013 Procedure for Handling Harassment Incidents](https://us.pycon.org/2013/about/code-of-conduct/harassment-incidents/).
...
This Code of Conduct is licensed under a [Creative Commons Attribution 4.0 International](https://creativecommons.org/licenses/by/4.0/) (CC BY 4.0 CA) license which means you are free to share and adapt the work so long as the attribution is retained to the Open By Design project along with all of the other source projects described above.